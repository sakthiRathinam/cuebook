...
DEFAULT_FILE_STORAGE = 'coresingle.storages.MediaStore'
CELERY_IMPORTS = (
    'alertsystem.backgroundtasks',
    'invoicegenerator.backgroundtasks',
)
# from coresingle.aws.conf import *
# from coresingle.aws.utils import *
